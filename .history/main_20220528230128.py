...
st.write("Managing billing systems for business in India, implemented using latest technology like blockchain.​")
st.write("Ensuring security and reliability of  billing transactions between businesses and customers. Each block can contain information about a bill.​")
with st.sidebar:
